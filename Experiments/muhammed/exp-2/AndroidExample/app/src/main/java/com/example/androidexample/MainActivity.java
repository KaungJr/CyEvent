...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String COUNTER_VALUE_KEY = "NUM";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null && extras.getString(COUNTER_VALUE_KEY) != null) {
            String number = extras.getString(COUNTER_VALUE_KEY);
